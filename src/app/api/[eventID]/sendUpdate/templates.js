    ...
    >
      ...
      <tr style="background-color:#e1c0b7">
        <td style="text-align: center; padding-top: 20px">
          ...
          <p style="font-size: 16px; margin-bottom: 20px">There has been an update to our event.</p>
        </td>
      </tr>
      <tr>
...
There has been an update to the event. Time for "Kushi Jaman and Majlis" has been set for 5:45 PM on August 2nd. Please click the button to view the latest details</p>
</br>
<p>
